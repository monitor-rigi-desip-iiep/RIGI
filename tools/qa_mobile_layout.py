...
def main() -> int:
    ...
    checks = {
        ...
        "imports_mobile_period_width_compact": "Math.max(22, Math.min(32, usableInitialWidth / targetVisiblePeriods))" in imports_js,
        "imports_mobile_visible_period_targets": "function mobileTargetVisiblePeriods" in imports_js and "return 8;" in imports_js and "return 9;" in imports_js and "return 10;" in imports_js and "return 11;" in imports_js,
        "imports_all_four_charts_dense_mobile": imports_js.count("{ denseMobile: true }") >= 4 and "denseMobile && baseProfile.mobile ? 11 : 14" in imports_js,
        "imports_all_chart_bargaps_responsive": imports_js.count("bargap: importBargap(") >= 4 and "bargap: 0.30" not in imports_js,
        "imports_scroll_only_for_long_series": "const scrollThreshold = denseMobile && baseProfile.mobile ? 11 : 14;" in imports_js,
